...
public struct MetalAssistant {
    public struct Pipelines {
        ...
        public let textureIO: GranitePipeline<GraniteMLImage>
...
extension MetalAssistant {
    ...
    public static func TextureToImagePipeline() -> GranitePipeline<GraniteMLImage> {
